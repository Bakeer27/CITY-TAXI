            ...
            <?php if ($taxiDetailsStmt): ?>
                <?php while ($taxi = $taxiDetailsStmt->fetch(PDO::FETCH_ASSOC)): ?>
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <img src="./img/hero2.png" class="card-img-top" alt="Vehicle">
                            <div class="card-body">
                                ...
                                <?php if ($taxi['vehicle_Status']=='Available'): ?>
                                    <a href="booking.php" class="btn btn-clr btn-block">Book Now</a>
                                <?php else: ?>
                                    <a href="#" class="btn btn-clr btn-block disabled">Not Available</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
