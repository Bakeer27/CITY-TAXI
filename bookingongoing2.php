...
$BookingDetails = $booking->getBookingDetails2($passengerId);
?>
...
<main class="container py-5">
    ...
    <div class="row">
        <!-- Check if there are ongoing bookings -->
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Contact No: <?php echo htmlspecialchars($bookingDetails['ContactNO']); ?></p>
        ...
        <?php else: ?>
            <div class="col-12">
                <p class="text-center text-danger"><?php echo isset($BookingDetails['message']) ? htmlspecialchars($BookingDetails['message']) : 'No ongoing bookings found.'; ?></p>
            </div>
        <?php endif; ?>
    </div>
</main>
